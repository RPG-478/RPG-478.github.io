    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-50 via-white to-blue-50 flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          >
            {/* Cute gradient bg */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-pink-100 via-purple-50 to-transparent rounded-bl-full opacity-60 transition-opacity group-hover:opacity-100" />
            
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-pink-400 to-purple-400 flex items-center justify-center text-white shadow-lg shadow-pink-200">
                  <Heart className="w-6 h-6" />
                </div>
                <div>
                  <h2 className="text-lg sm:text-xl font-black text-slate-900">はじめての方</h2>
                  <p className="text-xs text-pink-500 font-bold">かんたんモード</p>
                </div>
              </div>

              <p className="text-sm text-slate-600 mb-5 leading-relaxed">
                やさしいガイド付きで、<strong className="text-pink-600">誰でもかんたん</strong>に図が作れます。
                むずかしいコードは一切不要！
              </p>
              ...
              <div className="flex items-center gap-2 text-sm font-black text-pink-500 group-hover:text-pink-600 transition-colors">
